...
var _channelstore = require("./channel-storage/channelstore");

var ChannelStore = _interopRequireWildcard(_channelstore);

var _localchannelindex = require("./web/localchannelindex");

var _localchannelindex2 = _interopRequireDefault(_localchannelindex);

var _ioconfig = require("./configuration/ioconfig");

var _ioconfig2 = _interopRequireDefault(_ioconfig);

var _webconfig = require("./configuration/webconfig");

var _webconfig2 = _interopRequireDefault(_webconfig);

var _nullclusterclient = require("./io/cluster/nullclusterclient");

var _nullclusterclient2 = _interopRequireDefault(_nullclusterclient);
...
var Server = function Server() {
    ...
    // webserver init -----------------------------------------------------
    var ioConfig = _ioconfig2.default.fromOldConfig(Config);
    var webConfig = _webconfig2.default.fromOldConfig(Config);
    var clusterClient = initModule.getClusterClient();
    var channelIndex = new _localchannelindex2.default();
